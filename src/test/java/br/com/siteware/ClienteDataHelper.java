...
public class ClienteDataHelper {
	public static final UUID ID_CLIENTE = UUID.fromString("8d58875d-2455-4075-8b5d-57c73fcf1241");
	public static final String DATA_USUARIO_INVALIDO = "";

	public static Cliente createCliente() {
		return Cliente.builder().idCliente(ID_CLIENTE).nome("Exemplo da Silva").email("exemplo@gmail.com")
